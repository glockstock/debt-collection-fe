...
// Set the CloudFlare Worker URL here after deployment
const CLOUDFLARE_WORKER_URL = 'https://cors-proxy.your-username.workers.dev';

const baseURL = isDevelopment 
  ? '/api' // This will be proxied via Vite
  : CLOUDFLARE_WORKER_URL; // Use the CloudFlare Worker as a CORS proxy in production
